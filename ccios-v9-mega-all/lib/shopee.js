...
// 1. Register an app at https://open.shopee.com/ → get PARTNER_ID + PARTNER_KEY
// 2. Set SHOPEE_PARTNER_ID / SHOPEE_PARTNER_KEY / SHOPEE_HOST in env vars
// 3. Authorize your shop by visiting /api/auth/shopee — this redirects you to
...
// below for a persistent store (Vercel KV, Upstash Redis, or your own DB) —
...
export const tokenStore = {
  get: (shopId) => mem[shopId],
  set: (shopId, tokens) => (mem[shopId] = tokens),
  has: (shopId) => Boolean(mem[shopId]),
  all: () => mem,
};
